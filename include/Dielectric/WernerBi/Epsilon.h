...
return 1. + LL( 0.0*eV,     0.087*eV, 108.4*eV*eV)
          + LL( 3.9*eV,     1.800*eV,  23.6*eV*eV)
          + LL( 6.6*eV,     4.500*eV,  50.2*eV*eV)
          + LL(11.3*eV,     6.200*eV,  44.8*eV*eV)
          + LL(24.1*eV,     0.600*eV,   6.6*eV*eV)
          + LL(27.5*eV,     1.900*eV,  13.2*eV*eV)
          + LL(40.2*eV,     9.600*eV,  99.3*eV*eV)
          + LL(55.8*eV,    21.700*eV, 326.8*eV*eV)
          + LL(84.2*eV,    48.400*eV, 373.1*eV*eV)
}
