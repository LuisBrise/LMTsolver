...
fsm::path generate_LMT_path(const SimulationConfig& config,
...
fsm::path generate_dpdw_path(const SimulationConfig& config,
                             const std::string& component = "")  {
