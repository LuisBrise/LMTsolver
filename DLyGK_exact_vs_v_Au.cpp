...
sprintf(filenamex, "Results/LyvAu/%d/dldw_a%.2gnm_v%.2g_b%.2gnm.dat", Lmax, a/(1.*nm), vv, b/(1.*nm));
...
sprintf(filename, "Results/LyvAu/%d/DL_a%.2gnm_b%.2gnm.dat", Lmax,a/(1.*nm), b/(1.*nm));
...
sprintf(filenamer, "Results/LyvAu/%d/DL_a%.2gnm_b%.2gnm_error.dat", Lmax, a/(1.*nm), b/(1.*nm));
