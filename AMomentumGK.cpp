...
//
//   This program computes the spectral angular momentum dL/dw transferred to a 
...
//   the the dLdw is the linear momentum, and its imaginary part 
//   the estimated error.   
//
...
//          Modified by Jorge Luis Briseño Gómez, jorgeluisbrisenio@ciencias.unam.mx (04/06/23)
//
//	flags 
//      g++ -o AMomentumGK.out AMomentumGK.cpp -lcomplex_bessel -w 
//      g++ -o AMomentumGK.out AMomentumGK.cpp -lcomplex_bessel -w && ./AMomentumGK.out 
//
//**********************************************************************************************************************
//**********************************************************************************************************************
...
//*********************************************************************************************************
// Constructs the maxwell stress tensor and calculates its surface integral, writes to dLdwx, 
// dLdwz and dLdwy. Real part is its value and imaginary its error (konrod integration). 
// [0] Electric contribution. [1] Magnetic contribution.
//*********************************************************************************************************
//*********************************************************************************************************
void dpdw(double r, double w, double vv, double b, double a, dcomplex dLdwx[6], dcomplex dLdwy[6], dcomplex dLdwz[6]){
...
double TEesx, TEesy, TEesz, THesx, THesy, THesz;
double TEssx, TEssy, TEssz, THssx, THssy, THssz;
double TEeex, TEeey, TEeez, THeex, THeey, THeez;
double theta, phi;
