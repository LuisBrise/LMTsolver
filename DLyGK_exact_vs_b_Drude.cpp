...
sprintf(filenamex, "Results/LybDrude/%d/dldw_a%.2gnm_v%.2g_b%.2gnm.dat", Lmax, a/(1.*nm), vv, b/(1.*nm));
...
sprintf(filename, "Results/LybDrude/%d/DL_a%.2gnm_v%.2g.dat", Lmax,a/(1.*nm), vv);
...
sprintf(filenamer, "Results/LybDrude/%d/DL_a%.2gnm_v%.2g_error.dat", Lmax, a/(1.*nm), vv);
