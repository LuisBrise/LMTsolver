...
fprintf(fpp,"\n");
fprintf(fpp,"         DLEy                  DLHy                  DLEsy                  DLHsy\n");
...
fprintf(fppe,"\n");
fprintf(fppe,"       errDLEy                errDLHy                 errDLEsy                errDLHsy\n");
...
fprintf(fpx,"\n");
fprintf(fpx,"         w(au)                   dlEdwy                   dlHdwy                 dlEsdwy                   dlHsdwy\n");
...
fprintf(fpx,"%.17g %.17g %.17g %.17g %.17g %.17g %.17g \n",w,dldwy[0],dldwy[1],dldwy[2], dldwy[3], dldwy[4],dldwy[5]);
...
fprintf(fpp,"%.17g %.17g %.17g %.17g  %.17g %.17g \n",DLy[0].real(),DLy[1].real(),DLy[2].real(),DLy[3].real(),DLy[4].real(),DLy[5].real());
fprintf(fppe,"%.17g %.17g %.17g %.17g %.17g %.17g \n",DLy[0].imag(),DLy[1].imag(),DLy[2].imag(),DLy[3].imag(),DLy[4].imag(),DLy[5].imag());
